...
interface RecentStatusChangesCardProps {
  recentStatusChanges: RecentStatusChange[];
}

export const RecentStatusChangesCard: React.FC<RecentStatusChangesCardProps> = ({ recentStatusChanges }) => {
  return (
    <Card 
    ...
    >
      ...
      <Table className="w-full">
        ...
        <TableBody>
          {recentStatusChanges.map((status) => (
